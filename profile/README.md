...
Currently, only libraries are provided for Python. The libraries, however, work with various game frameworks such as [Pygame](https://pyga.me/) and [Arcade](https://api.arcade.academy/en/stable/). In the future, further language support is planned.
